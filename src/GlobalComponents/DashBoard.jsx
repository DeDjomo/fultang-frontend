...
/**
 * Composant Dashboard principal utilisé par de nombreux rôles.
 * Supporte le responsive design et l'internationalisation.
 */
export function DashBoard({ children, linkList, requiredRole }) {
    ...
    useEffect(() => {
        const checkAuth = async () => {
            // Petit délai pour laisser Provider.jsx restaurer l'état
