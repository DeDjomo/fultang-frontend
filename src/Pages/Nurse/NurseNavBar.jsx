        ...
        <div className="flex flex-col w-full">
            <div className="border-b-2 m-2 md:m-3 border-b-gray-300">
                <div className="w-full min-h-[60px] md:h-[70px] flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0 py-2 md:py-0">
                    <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mt-1 md:mt-3 ml-0 md:ml-5 text-center md:text-left pl-12 lg:pl-0">
                        <span>{t('nurse.title')}</span>
                    </div>
                    <div className="flex flex-wrap gap-2 md:gap-3 mt-1 md:mt-4 mb-2 md:mb-4 mr-2 md:mr-5 justify-center md:justify-end items-center">
                        <LanguageSwitcher />
                        <Tooltip placement={"top"} title={t('navbar.logout')}>
                            <button
                                ...
                                className="w-10 h-9 md:w-12 md:h-10 border-2 bg-red-500 flex justify-center items-center rounded-xl shadow-xl hover:bg-white text-white text-lg md:text-xl hover:text-red-500 transition-all duration-300"
                            >
                                <FaSignOutAlt />
                            </button>
                        </Tooltip>
            ...
            <div className="flex-1 min-h-[calc(100vh-80px)] mt-2 md:mt-5">
                {children}
            </div>
        </div>
    )
